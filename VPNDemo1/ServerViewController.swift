...
class ServerViewController: UIViewController, UITableViewDelegate {
    ...
    var serverList: [Server] = [Server(serverName: "United States", imageView: UIImage(named: "usa_flag")!),
                                Server(serverName: "Japan", imageView: UIImage(named: "japan")!),
                                Server(serverName: "Sweden", imageView: UIImage(named: "sweden")!),
                                Server(serverName: "Korea", imageView: UIImage(named: "korea")!),
                                Server(serverName: "France", imageView: UIImage(named: "fr_flag")!),
                                Server(serverName: "United Kingdom", imageView: UIImage(named: "uk_flag")!)]
